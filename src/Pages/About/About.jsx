...
const testimonials = [
    {
        name: 'design by Centurion ST Domain Students',
        role: 'Software Technology',
        content:
            'A resume builder website is a web-based tool that allows users to create and customize a professional resume to their desired specifications. This website typically provides templates for creating a resume.',
            avatar:
            'https://tse3.mm.bing.net/th?id=OIP.7nxLvOj1lxjVY6QZpLVUoAAAAA&pid=Api&P=0&h=180',
